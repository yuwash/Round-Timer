...
},{"process":"node_modules/process/browser.js"}],"js/round.js":[function(require,module,exports) {
"use strict";
...
var getElapsedProgress = function getElapsedProgress() {
  return [totalElapsedSeconds, totalSeconds];
};

var getLeftProgress = function getLeftProgress() {
...
var TimeDisplay = function TimeDisplay(minutesElement, secondsElement, useSelect) {
...
var DisplayedTime = function DisplayedTime(timeDisplays, mobileTimeDisplays, onChangeFunction) {
...
DisplayedTime.prototype.addSeconds = function (secondsToAdd) {
  ...
  if (newSeconds >= 60 || newSeconds < 0) {
    ...
    newMinutes += this.__minutes; // XXX hours will be forgotten
...
var DisplayedCounter = function DisplayedCounter(displayElement, onChangeFunction) {
...
var ProgressDisplay = function ProgressDisplay(durationElement, barElement, getProgress) {
  this.durationElement = durationElement;
  this.barElement = barElement;

  this.getProgress = getProgress || function () {
    return 0;
  };
};
...
$(document).ready(function () {
  ...
  var updateTotalElapsedSeconds = function updateTotalElapsedSeconds() {
    if (sleeping) {
      totalElapsedSeconds = 0;
      return;
    }
  ...
  var progressWrite = function progressWrite(m, s) {
  ...
  var updateTotalSeconds = function updateTotalSeconds(m, s) {
  ...
  var initPrep = function initPrep() {
  ...
  var initRest = function initRest() {
    gong.play();
    resting = true;
    roundsCounter.dec();
  ...
  var counter = function counter() {
    ...
    var countdown = setInterval(function () {
      if (preping) {
        ...
        endRest();
      } else if (roundsCounter.get() <= 1) {
        // 1 is the last round, so no rest
...
},{"moment":"node_modules/moment/moment.js","jquery":"node_modules/jquery/dist/jquery.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "33758" + '/');
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/round.js"], null)
//# sourceMappingURL=/round.96e57cfb.js.map